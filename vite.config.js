...
const localizedRoutes = {
  ...
  productTulaModel1: { bg: '/lamps/tula-model-1-sewing-machine-lamp', en: '/en/lamps/tula-model-1-sewing-machine-lamp' },
...
const instagramProductSeo = [
  ...
  ['productBlackWhiteTelephone', 'Черно-бял ретро телефон', 'Black and White Retro Telephone Lamp', 'products/black-white-telephone-lamp-main.jpg', 'Handmade vintage telephone lamp'],
]
